...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('../images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >服务出租系统</font></div>
			...
			<div class="row-fluid">
				<div class="span2 bs-docs-sidebar" >
					<ul class="nav nav-list bs-docs-sidenav">
						...
						<li><a href="client?action=list"><i class="icon-chevron-right"></i>客户管理</a></li>
						<li><a href="project?action=list"><i class="icon-chevron-right"></i>项目管理</a></li>
						<li><a href="contract?action=list"><i class="icon-chevron-right"></i>合同管理</a></li>
						<li><a href="timetable?action=list"><i class="icon-chevron-right"></i>时间表管理</a></li>
						<li><a href="freelancer?action=list"><i class="icon-chevron-right"></i>自由职业者管理</a></li>
