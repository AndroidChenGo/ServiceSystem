...
<div class="data_list">
	...
	<form name="myForm" class="form-search" method="post" action="freelancer?action=search" style="padding-bottom: 0px">
	<button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='freelancer?action=preSave'">添加</button>
...
<%--						<td>${user.password }</td>--%>
						...
						<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='freelancer?action=preSave&userId=${user.id }'">修改</button>&nbsp;
							<button class="btn btn-mini btn-danger" type="button" onclick="freelancerDelete(${user.id })">删除</button></td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
