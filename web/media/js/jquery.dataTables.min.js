...
null:null});r("row.add()",function(a){a instanceof h&&a.length&&(a=a[0]);var b=this.iterator("table",function(b){return a.nodeName&&"TR"===a.nodeName.toUpperCase()?ha(b,a)[0]:I(b,a)});return this.row(b[0])});var bb=function(a){var b=a.context;b.length&&a.length&&(a=b[0].aoData[a[0]],a._dormBuildTypes&&(a._dormBuildTypes.remove(),a._dormBuildTypesShow=l,a._dormBuildTypes=l))},Tb=function(a,b){var c=a.context;if(c.length&&a.length){var d=c[0].aoData[a[0]];if(d._dormBuildTypes){(d._dormBuildTypesShow=b)?d._dormBuildTypes.insertAfter(d.nTr):d._dormBuildTypes.detach();
var e=c[0],f=new q(e),g=e.aoData;f.off("draw.dt.DT_dormBuildTypes column-visibility.dt.DT_dormBuildTypes destroy.dt.DT_dormBuildTypes");0<C(g,"_dormBuildTypes").length&&(f.on("draw.dt.DT_dormBuildTypes",function(a,b){e===b&&f.rows({page:"current"}).eq(0).each(function(a){a=g[a];a._dormBuildTypesShow&&a._dormBuildTypes.insertAfter(a.nTr)})}),f.on("column-visibility.dt.DT_dormBuildTypes",function(a,b){if(e===b)for(var c,d=Z(b),f=0,h=g.length;f<h;f++)c=g[f],c._dormBuildTypes&&c._dormBuildTypes.children("td[colspan]").attr("colspan",d)}),f.on("destroy.dt.DT_dormBuildTypes",function(a,
b){if(e===b)for(var c=0,d=g.length;c<d;c++)g[c]._dormBuildTypes&&bb(g[c])}))}}};r("row().child()",function(a,b){var c=this.context;if(a===l)return c.length&&this.length?c[0].aoData[this[0]]._dormBuildTypes:l;if(!0===a)this.child.show();else if(!1===a)bb(this);else if(c.length&&this.length){var d=c[0],c=c[0].aoData[this[0]],e=[],f=function(a,b){if(a.nodeName&&"tr"===a.nodeName.toLowerCase())e.push(a);else{var c=h("<tr><td/></tr>").addClass(b);h("td",c).addClass(b).html(a)[0].colSpan=Z(d);e.push(c[0])}};if(h.isArray(a)||
a instanceof h)for(var g=0,j=a.length;g<j;g++)f(a[g],b);else f(a,b);c._dormBuildTypes&&c._dormBuildTypes.remove();c._dormBuildTypes=h(e);c._dormBuildTypesShow&&c._dormBuildTypes.insertAfter(c.nTr)}return this});r(["row().child.show()","row().child().show()"],function(){Tb(this,!0);return this});r(["row().child.hide()","row().child().hide()"],function(){Tb(this,!1);return this});r(["row().child.remove()","row().child().remove()"],function(){bb(this);return this});r("row().child.isShown()",function(){var a=this.context;return a.length&&
this.length?a[0].aoData[this[0]]._dormBuildTypesShow||!1:!1});var ac=/^(.*):(name|visIdx|visible)$/;r("columns()",function(a,b){a===l?a="":h.isPlainObject(a)&&(b=a,a="");var b=$a(b),c=this.iterator("table",function(b){var c=a,f=b.aoColumns,g=C(f,"sName"),j=C(f,"nTh");return Za(c,function(a){var c=Ob(a);if(a==="")return S(f.length);if(c!==null)return[c>=0?c:f.length+c];var e=typeof a==="string"?a.match(ac):"";if(e)switch(e[2]){case "visIdx":case "visible":a=parseInt(e[1],10);if(a<0){c=h.map(f,function(a,
